...
export default function Other() {
    ...
    return (
        ...
        >
            ...
            <div
                aria-hidden="true"
                className="absolute top-0 right-1/4 w-[520px] h-[320px] bg-[#f5a623]/[0.035] blur-[150px] rounded-full pointer-events-none z-0"
            />
            <div
                aria-hidden="true"
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
                ...
                >
                    <div>
                        {/* Eyebrow Badge */}
                        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-amber-400/10 border border-amber-400/20 text-[#f5a623] text-xs font-semibold uppercase tracking-widest mb-3">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6">
                    {mediaItems.map((item, index) => (
                        <div
                            ...
                            className={`group relative p-6 rounded-xl bg-[#171a23]/75 backdrop-blur-md border border-slate-800/80 hover:border-amber-500/40 hover:bg-[#1c202c]/90 transition-all duration-300 ease-out cursor-pointer flex flex-col justify-between gap-5 overflow-hidden shadow-sm hover:shadow-xl hover:shadow-black/40 hover:-translate-y-1 transform ${isVisible
                                    ? "translate-y-0 opacity-100"
                                    : "translate-y-8 opacity-0"
                                }`}
                        >
                            {/* Subtle Ambient Gold Top-border Highlight on Hover */}
                            <div className="absolute top-0 left-0 right-0 h-[2px] bg-gradient-to-r from-transparent via-[#f5a623]/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none" />

                            {/* Top Details: Category Pill & Read Time */}
                            <div>
                                <div className="flex items-center justify-between gap-2 mb-3">
                                    <span className="inline-flex items-center gap-1.5 text-[11px] font-medium tracking-wider text-[#f5a623] uppercase">
                                ...
                                <h3 className="text-base sm:text-[17px] font-medium text-slate-100 group-hover:text-amber-300 transition-colors duration-200 leading-snug">
                                    {item.title}
                                </h3>
                            ...
                            <div className="pt-3 border-t border-slate-800/60 flex items-center justify-between text-xs text-slate-400 group-hover:text-amber-400 transition-colors duration-200">
                                <span className="font-medium">Read Story</span>
                                <div className="w-7 h-7 rounded-full bg-slate-800/70 group-hover:bg-amber-400/10 group-hover:text-amber-400 flex items-center justify-center transition-all duration-300 transform group-hover:translate-x-1">
                                    <svg
                ...
                >
                    ...
                    >
                        ...
                        <button
                            ...
                            className="absolute top-5 right-5 w-8 h-8 rounded-full bg-slate-800 text-slate-400 hover:text-white hover:border-[#f5a623] hover:bg-[#f5a623]/20 flex items-center justify-center transition-all cursor-pointer"
                        >
                        ...
                        <div className="flex items-center gap-2 mb-3">
                            <span className="px-2.5 py-0.5 rounded-full text-[10px] font-mono font-medium uppercase tracking-wider bg-amber-500/10 text-[#f5a623] border border-amber-500/30">
                        ...
                        {/* Tagline */}
                        <p className="text-sm font-medium text-[#f5a623] mb-4">
                        ...
                        <div className="flex items-center justify-end gap-3 pt-4 border-t border-slate-800">
                            <button
                                type="button"
                                onClick={() => setActiveModalItem(null)}
                                className="px-5 py-2 rounded-lg bg-[#f5a623] hover:bg-amber-400 text-slate-950 font-semibold text-xs uppercase tracking-wider transition-all duration-200 cursor-pointer shadow-md shadow-amber-500/20"
                            >
                                Close Article
                            </button>
                        </div>
