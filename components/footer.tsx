            ...
            <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 py-16 sm:py-20">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8 items-start">
                    ...
                    <div className="lg:col-span-5 space-y-6">
                        {/* ALDA Logo matching Header */}
                        <Link href="/" className="inline-flex items-center gap-3 group">
                            {/* Architectural badge icon */}
                            <div className="w-11 h-11 rounded-xl bg-gradient-to-br from-amber-500 to-amber-700 flex items-center justify-center text-white shadow-md shadow-amber-500/20 group-hover:scale-105 transition-all duration-200">
                                <svg
                                    className="w-5 h-5"
                                    fill="none"
                                    stroke="currentColor"
                        ...
                        <div className="space-y-3.5 pt-2">
                            ...
                            <div className="flex items-start gap-3 text-xs sm:text-sm text-slate-300">
                                <div className="w-5 h-5 text-[#ea580c] flex-shrink-0 mt-0.5">
                            ...
                            <div>
                                <a
                                    ...
                                    className="inline-flex items-center gap-3 text-xs sm:text-sm text-slate-300 hover:text-[#ea580c] transition-colors"
                                >
                                    <div className="w-5 h-5 text-[#ea580c] flex-shrink-0">
                                        <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                    ...
                    <div className="lg:col-span-2 sm:pl-4">
                        <h3 className="text-xs font-bold uppercase tracking-[0.25em] text-[#ea580c] mb-5">
                            Company
                        </h3>
